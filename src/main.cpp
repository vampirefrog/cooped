...
SDL_AppResult SDL_AppIterate(void* appstate) {
	...
	if (app->editMode) {
		...
		bgfx::dbgTextPrintf(1, 2, 0x0a, "E:play  L-click:select  Enter:new  X/Del:delete");
		bgfx::dbgTextPrintf(1, 3, 0x0a, "arrows/PgUp/PgDn:move  wheel:grid  Ctrl+Z/Y:undo/redo");
	} else {
